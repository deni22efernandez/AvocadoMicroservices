...
using Avocado.Services.IdentityServer.MainModule.Account;
		...
		public async Task<IActionResult> Login(LoginInputModel model, string button)
		{
			...
			if (ModelState.IsValid)
			{
				...
				if (result.Succeeded)
				{
					...
					await _events.RaiseAsync(new UserLoginSuccessEvent(loggedUser.UserName, loggedUser.Id, loggedUser.UserName, clientId: context?.Client.ClientId));
		...
		public async Task<IActionResult> Register(RegisterViewModel vm)
		{
			if (ModelState.IsValid)
			{
				...
				if (result.Succeeded)
				{
					...
					{
						await _roleManager.CreateAsync(new IdentityRole { Name = vm.RoleName, NormalizedName = vm.RoleName });
					}
					...
					await _userManager.AddClaimsAsync(newUser, new Claim[]
					{
						...
						new Claim(JwtClaimTypes.Role, vm.RoleName),
					...
					var loginResult = await _signInManager.PasswordSignInAsync(newUser, vm.Password, false, false);
